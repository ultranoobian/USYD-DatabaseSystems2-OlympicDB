 ...
 * @author Bryn
 */
public class Place implements TupleConverter {
	public static final String[] attributeNames = {"place_name", "Address"};
	public static final Class<?>[] attributeClasses = {String.class, String.class};
